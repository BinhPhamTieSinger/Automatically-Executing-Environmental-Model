...
path_tiff_files = "D:/Code_Result/Result/NASA_TUTORIAL_SPACE/EMISSION6/AIR/TIFF/"
...
output_folder_Air = "D:/Code_Result/Result/NASA_TUTORIAL_SPACE/EMISSION6/AIR/EXCEL/RV/"
...
ds_Air = xr.open_dataset(data_Air_co)
df_Air = pd.DataFrame()
...
for variable in variable_Air:
    for time_df in time_Data_excel_2023:
        for substance in substance_Air:
            ...
            df_Air["LON"], df_Air["LAT"] = df_Excel["POINT_X"], df_Excel["POINT_Y"]
...
for raster in tqdm(rasters, desc="Processing files", total=total_iterations):
    ...
    for value_substance in list_Value_Substance[substance]:
        ...
        excel_file_path_df = f"D:/Code_Result/Result/NASA_TUTORIAL_SPACE/EMISSION6/AIR/EXCEL/DF/{occupation}_{value_substance_x}_{sector_x}_{int(date[0:2])}_{substance}.xlsx"
        excel_file_path_cb = f"D:/Code_Result/Result/NASA_TUTORIAL_SPACE/EMISSION6/AIR/EXCEL/CB/{occupation}_{value_substance_x}_{sector_x}_{int(date[0:2])}_{substance}.xlsx"
        # excel_file_path_df = f"D:/Code_Result/Result/Emission_thang10/CAMS_GLOB_AIR_EXCEL/DF_Test/{occupation}_{value_substance_x}_{sector_x}_{int(date[0:2])}_{substance}.xlsx"
        # excel_file_path_cb = f"D:/Code_Result/Result/Emission_thang10/CAMS_GLOB_AIR_EXCEL/CB_Test/{occupation}_{value_substance_x}_{sector_x}_{int(date[0:2])}_{substance}.xlsx"
